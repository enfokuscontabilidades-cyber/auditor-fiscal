...
const dados: DadosRelatorioFiscalPdf = {
  ...
  filtros: ['Entradas', 'Somente documentos ativos', 'ICMS: qualquer'],
  gerado_em: '21/07/2026 11:30',
  totais: {
    documentos: 167,
    valor_operacoes: 43125.91,
    base_icms: 321.5,
    icms: 57.87,
    st: 0,
    ipi: 14.21,
...
const outputPath = path.join(outputDir, 'relatorio-fiscal-amostra.pdf')
await fs.writeFile(outputPath, await renderToBuffer(<RelatorioFiscalSinteticoPdf dados={dados} />))

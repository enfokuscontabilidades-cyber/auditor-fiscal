-- Corrige o agrupamento de CFOP na funcao de refresh dos resumos mensais.
-- Execute este arquivo no Supabase SQL Editor se o botao "Recalcular resumos"
-- retornar: column "i.cfop" must appear in the GROUP BY clause.
